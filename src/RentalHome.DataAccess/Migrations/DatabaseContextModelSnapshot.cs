...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentalHome.Core.Entities.Tenant", b =>
                {
                    ...
                    b.Property<int>("PreferredPropertyTypeId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PreferredPropertyTypeId");
            ...
            modelBuilder.Entity("RentalHome.Core.Entities.Property", b =>
                {
                    ...
                    b.HasOne("RentalHome.Core.Entities.PropertyType", "PropertyType")
                        .WithMany("Properties")
            ...
            modelBuilder.Entity("RentalHome.Core.Entities.Tenant", b =>
                {
                    b.HasOne("RentalHome.Core.Entities.PropertyType", "PreferredPropertyType")
                        .WithMany()
                        .HasForeignKey("PreferredPropertyTypeId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();

                    b.HasOne("RentalHome.Core.Entities.PropertyType", null)
                        .WithMany("Tenants")
                        .HasForeignKey("PropertyTypeId");
                    ...
                    b.Navigation("PreferredPropertyType");
