...
namespace RentalHome.DataAccess.Migrations
{
    ...
    [Migration("20250731051813_UpdatedUserTokenExpiry")]
    partial class UpdatedUserTokenExpiry
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentalHome.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 31, 5, 18, 12, 146, DateTimeKind.Utc).AddTicks(2484),
